...
<label>ISBN</label>
<input type="text" name="isbn" value="{{ $rs->isbn }}" class="form-control" required/>
<label>Judul</label>
<input type="text" name="judul" value="{{ $rs->judul }}" class="form-control" required/>
<label>Tahun Cetak</label>
<input type="text" name="tahun_cetak" value="{{ $rs->tahun_cetak }}" class="form-control" required/>
<label>Stok</label>
<input type="text" name="stok" value="{{ $rs->stok }}" class="form-control" required/>
</div>
<div class="form-group">
<label>Pengarang</label>
<select class="form-control" required name="idpengarang">
...
<select class="form-control" required name="idpenerbit">
...
<label>Cover</label>
<input type="text" name="cover" value="{{ $rs->cover }}" class="form-control" required/>
